  ...
  const testiData = [
    {
      cards: [
        ...
        ,
        { text: "Our restaurant finally has a site that looks as good as the food. Reservations through WhatsApp jumped within weeks of launch.", text_en: "Our restaurant finally has a site that looks as good as the food. Reservations through WhatsApp jumped within weeks of launch.", text_fr: "Notre restaurant a enfin un site à la hauteur de la cuisine. Les réservations via WhatsApp ont grimpé quelques semaines après le lancement.", text_ar: "أصبح لمطعمنا أخيراً موقع يضاهي جودة الطعام. ارتفعت الحجوزات عبر واتساب خلال أسابيع من الإطلاق.", name: "Salma Idrissi", img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=192&h=192&fit=crop&crop=faces&auto=format&q=80", name_en: "Salma Idrissi", name_fr: "Salma Idrissi", name_ar: "سلمى الإدريسي", role: "Restaurant Owner", role_en: "Restaurant Owner", role_fr: "Propriétaire de restaurant", role_ar: "صاحبة مطعم" },
        { text: "Clear communication, fast delivery, and a site that actually brings in qualified leads. Exactly what our agency needed.", text_en: "Clear communication, fast delivery, and a site that actually brings in qualified leads. Exactly what our agency needed.", text_fr: "Communication claire, livraison rapide, et un site qui génère vraiment des prospects qualifiés. Exactement ce qu'il fallait à notre agence.", text_ar: "تواصل واضح وتسليم سريع وموقع يجلب فعلاً عملاء محتملين مؤهلين. هذا بالضبط ما احتاجته وكالتنا.", name: "Omar Tazi", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=192&h=192&fit=crop&crop=faces&auto=format&q=80", name_en: "Omar Tazi", name_fr: "Omar Tazi", name_ar: "عمر التازي", role: "Real Estate Agent", role_en: "Real Estate Agent", role_fr: "Agent immobilier", role_ar: "وكيل عقاري" },
        { text: "They understood our clinic's brand from the first call. The new site feels premium and our bookings have never been smoother.", text_en: "They understood our clinic's brand from the first call. The new site feels premium and our bookings have never been smoother.", text_fr: "Ils ont compris l'image de notre clinique dès le premier appel. Le nouveau site fait premium et nos prises de rendez-vous n'ont jamais été aussi fluides.", text_ar: "فهموا هوية عيادتنا منذ المكالمة الأولى. الموقع الجديد يبدو راقياً ولم تكن حجوزاتنا أكثر سلاسة من أي وقت مضى.", name: "Leila Fassi", img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=192&h=192&fit=crop&crop=faces&auto=format&q=80", name_en: "Leila Fassi", name_fr: "Leila Fassi", name_ar: "ليلى الفاسي", role: "Clinic Director", role_en: "Clinic Director", role_fr: "Directrice de clinique", role_ar: "مديرة عيادة" }
      ]
    }
  ];
